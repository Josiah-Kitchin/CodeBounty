...
router.get('/name/:id', (req: Request, res: Response) => { userController.getUserNameById(req, res); }); 

//Get a user's email by id'
router.get('/email/:id', (req: Request, res: Response) => { userController.getUserEmailById(req, res); });
